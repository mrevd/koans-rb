...
class AboutIteration < Neo::Koan
  ...
  def test_select_selects_certain_items_from_an_array
    ...
    assert_equal selection, even_numbers

    # NOTE: 'find_all' is another name for the 'select' operation
    more_even_numbers = array.find_all { |item| (item % 2) == 0 }
    assert_equal selection, more_even_numbers
  end
  ...
  def test_inject_will_blow_your_mind
    ...
    # Oh yeah, sure. It takes each member of an enumerable object and runs
    # a block on on them. The return of that block is then assigned to a container
    # such as sum or product. How's that?
  end
